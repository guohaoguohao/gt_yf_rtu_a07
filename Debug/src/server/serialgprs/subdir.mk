...
CPP_SRCS += \
../src/server/serialgprs/SerialGprs.cpp 

OBJS += \
./src/server/serialgprs/SerialGprs.o 

CPP_DEPS += \
./src/server/serialgprs/SerialGprs.d 


# Each subdirectory must supply rules for building sources it contributes
src/server/serialgprs/%.o: ../src/server/serialgprs/%.cpp
	@echo 'Building file: $<'
