...
CPP_SRCS += \
../src/server/serialzigbeewia/SerialZigBeeWia.cpp 

OBJS += \
./src/server/serialzigbeewia/SerialZigBeeWia.o 

CPP_DEPS += \
./src/server/serialzigbeewia/SerialZigBeeWia.d 


# Each subdirectory must supply rules for building sources it contributes
src/server/serialzigbeewia/%.o: ../src/server/serialzigbeewia/%.cpp
	@echo 'Building file: $<'
